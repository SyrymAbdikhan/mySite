...
TRANSLATION = {
    ...
    'full':      {'eng': 'full schedule', 'ru': 'полное расписание', 'kz': 'толық кесте'},
    ...
    'alert2':           {'eng': '', 'ru': 'Расписание понедельника на 20 минут вперед', 'kz': ''},
    ...
    'бизнес және кәсіпкерлік': {'eng': 'Business', 'ru': 'Бизнес', 'kz': 'Бизнес'},
